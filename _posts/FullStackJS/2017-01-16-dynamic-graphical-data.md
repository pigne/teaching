...
- [*D3.js* Data-Driven Documents](#d3jshttpd3jsorg-smalldata-driven-documentssmall)
	- [The Design Pattern](#the-design-pattern)
	- [Drawing paths](#drawing-paths)
	- [Handle events](#handle-events)
	- [Fonctionnement avec React et Redux](#fonctionnement-avec-react-et-redux)
...
- [What Makes Software Good?](https://medium.com/@mbostock/what-makes-software-good-943557f8a488#.u66cxfx9j)
...
On va créer des composants react connectés au store et répondre aux évènements de mise à jour du composant réact (le [cycle de vie du composant](http://busypeoples.github.io/post/react-component-lifecycle/)):
